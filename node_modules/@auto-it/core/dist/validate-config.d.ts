...
export declare const validateIoConfiguration: (name: string, configDeceleration: t.Any | t.HasPropsRefinement | t.HasPropsReadonly | t.HasPropsIntersection | t.InterfaceType<any, any, any, any> | t.StrictType<any, any, any, any> | t.PartialType<any, any, any, any>) => (rc: unknown) => Promise<ConfigError[]>;
export declare const validateAutoRc: (rc: unknown) => Promise<ConfigError[]>;
