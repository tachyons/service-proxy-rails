...
class Git {
    ...
    constructor(options, logger = logger_1.dummyLog()) {
        ...
        const GitHub = rest_1.Octokit.plugin(plugin_enterprise_compatibility_1.enterpriseCompatibility)
    ...
    async getProjectLabels() {
        ...
        try {
            const labels = await this.github.paginate(this.github.issues.listLabelsForRepo.endpoint(args));
    ...
    async getTagNotInBaseBranch(branch, options = {}) {
        ...
        this.logger.verbose.info(`${options.first ? "First" : "Latest"} tag in branch:`, firstGreatestUnique);
